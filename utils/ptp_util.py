...
class CustomCrossAttnProcessor:
	...
	def __call__(
		...
		key = attn.to_k(encoder_hidden_states) # [2, 4096, 320]
		value = attn.to_v(encoder_hidden_states) # [2, 4096, 320]

		query = attn.head_to_batch_dim(query)
		key = attn.head_to_batch_dim(key)
		value = attn.head_to_batch_dim(value)

		attention_probs = attn.get_attention_scores(query, key, attention_mask) # attention map 
